**Definition**: $\Delta T_b$ and $\Delta T_f$ depend on the molality (mols/kg) of the solution as described by the following equations:

$$\Delta T_b = T_{bp} - T_{bp},0 = K_bm$$
$$\Delta T_f = T_{fp} - T_{fp},0 = -K_fm$$
where:
