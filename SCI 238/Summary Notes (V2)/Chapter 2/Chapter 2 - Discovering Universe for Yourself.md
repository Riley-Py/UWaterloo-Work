### **1. How star-trail photos are made**
...
- **Altitude:** Angular distance above the horizon.
    - Zenith = 90°
    - Horizon = 0°
    - Example: Sun’s center at sunrise/set = 0° altitude    
- **Direction (Azimuth):** Angular distance around the horizon, measured from **north**:
    - North = 0°
    - East = 90°
    - South = 180°
    - West = 270°
