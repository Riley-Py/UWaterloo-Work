...
- If $X_1, X_2, \cdots, X_n$ are independent random variables having normal distributions, then $Y = a_{1}X_1 + a_{2}X_2 + \cdots + a_{n}X_n$ has mean of $\mu_Y = a_{1}\mu_1 + a_{2}\mu_2 + \cdots + a_{n}\mu_n$ and variance $\sigma_Y^2 = {a_1^2}{\sigma_1^2} + {a_2^2}{\sigma_2^2} + \cdots + {a_n^2}{\sigma_n^2}$  
#mse253
#module5 