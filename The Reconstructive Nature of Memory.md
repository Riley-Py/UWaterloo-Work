...
- Bartlett used *serial reproduction* (having to recall the stories on more than one occasion) and was info was remembered and what was disremembered
	...
	- Showed that participants introduce distortions to make material more coherent from their schemata
	- *schema* - large unit of organized info used for representing concepts, situations, events, and actions in memory
