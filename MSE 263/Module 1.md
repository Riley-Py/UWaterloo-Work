- *Model* - isolates the most important features of a problem
	- Unrealistic, but useful for showing overall picture of problem/situation
- Assumptions about models:
	- *No uncertainty* - people know the info relevant to the problem
